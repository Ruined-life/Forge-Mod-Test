...
public class BlockRegistry {
    ...
    public static final RegistryObject<Block> DARKNESS_STAIRS = registerBlock("darkness_stairs", () -> new StairBlock(() -> BlockRegistry.DARKNESS_BLOCK.get().defaultBlockState(), BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).strength(5f).requiresCorrectToolForDrops()));
    ...
    public static final RegistryObject<Item> DARKNESS_DOOR_ITEM = ItemsRegistry.ITEMS.register("darkness_door", () -> new DoubleHighBlockItem(DARKNESS_DOOR.get(), new Item.Properties()));
    ...
    public static final RegistryObject<Block> POTTED_AQUA = BLOCKS.register("potted_aqua", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.AQUA, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_GREEN = BLOCKS.register("potted_green", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.GREEN, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_PURPLE = BLOCKS.register("potted_purple", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.PURPLE, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_GOLD = BLOCKS.register("potted_gold", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.GOLD, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_YELLOW = BLOCKS.register("potted_yellow", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.YELLOW, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_ORANGE = BLOCKS.register("potted_orange", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.ORANGE, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_BLUE = BLOCKS.register("potted_blue", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.BLUE, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
    ...
    public static final RegistryObject<Block> POTTED_PINK = BLOCKS.register("potted_pink", () -> new FlowerPotBlock(() -> ((FlowerPotBlock) Blocks.FLOWER_POT), BlockRegistry.PINK, BlockBehaviour.Properties.copy(Blocks.POTTED_ALLIUM).noOcclusion()));
