...
public class ItemsRegistry {
    ...
    public static final RegistryObject<Item> CHEST_SCANNER = ITEMS.register("chest_scanner", () -> new ChestScanner(new Item.Properties()));

    //REGULAR ITEMS
    public static final RegistryObject<Item> crystal_a = ITEMS.register("crystal_a", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> crystal_b = ITEMS.register("crystal_b", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> crystal_c = ITEMS.register("crystal_c", () -> new Item(new Item.Properties()));
    public static final RegistryObject<Item> crystal_d = ITEMS.register("crystal_d", () -> new Item(new Item.Properties()));
    ...
    public static final RegistryObject<Item> TORN_NOTEBOOK = ITEMS.register("torn_notebook", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.torn_notebook", ChatFormatting.LIGHT_PURPLE));
    public static final RegistryObject<Item> CLOUDY_GLASSES = ITEMS.register("cloudy_glasses", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.cloudy_glasses", ChatFormatting.WHITE));

    public static final RegistryObject<Item> BURNT_PAN = ITEMS.register("burnt_pan", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.burnt_pan", ChatFormatting.GRAY));
    public static final RegistryObject<Item> APRON = ITEMS.register("apron", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.apron", ChatFormatting.GREEN));

    public static final RegistryObject<Item> BALLET_SHOES = ITEMS.register("ballet_shoes", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.ballet_shoes", ChatFormatting.DARK_BLUE));
    public static final RegistryObject<Item> TUTU = ITEMS.register("tutu", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.tutu", ChatFormatting.WHITE));

    public static final RegistryObject<Item> TOY_GUN = ITEMS.register("toy_gun", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.toy_gun", ChatFormatting.YELLOW));
    public static final RegistryObject<Item> COWBOY_HAT = ITEMS.register("cowboy_hat", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.cowboy_hat", ChatFormatting.GRAY));

    public static final RegistryObject<Item> TOUGH_GLOVE = ITEMS.register("tough_glove", () -> new TooltipItem(new Item.Properties(), "tooltip.modtest.tough_glove", ChatFormatting.GRAY));
    ...
    public static final RegistryObject<Item> FEATHER = ITEMS.register("feather_item", () -> new FeatherItem(new Item.Properties()));
    ...
    public static final RegistryObject<Item> PINK_CHESTPLATE = ITEMS.register("pink_chestplate", () -> new ArmorItem(ModArmorMaterials.PINK, ArmorItem.Type.CHESTPLATE, new Item.Properties()));
    public static final RegistryObject<Item> PINK_LEGGINGS = ITEMS.register("pink_leggings", () -> new ArmorItem(ModArmorMaterials.PINK, ArmorItem.Type.LEGGINGS, new Item.Properties()));
    public static final RegistryObject<Item> PINK_BOOTS = ITEMS.register("pink_boots", () -> new ArmorItem(ModArmorMaterials.PINK, ArmorItem.Type.BOOTS, new Item.Properties()));
