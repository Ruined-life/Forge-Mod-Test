...
public class CustomBiomes {
    public static final ResourceKey<Biome> TEST_BIOME = ResourceKey.create(Registries.BIOME,
            new ResourceLocation(modtest.MOD_ID, "test_biome"));
    ...
    public static Biome testBiome(BootstapContext<Biome> context) {
        ...
        spawnBuilder.addSpawn(MobCategory.CREATURE, new MobSpawnSettings.SpawnerData(EntityRegistry.RHINO.get(), 2, 3, 5));
        ...
        biomeBuilder.addFeature(GenerationStep.Decoration.VEGETAL_DECORATION, PlacedFeatures.SCARLET_TREE_PLACED_KEY);
        ...
        return new Biome.BiomeBuilder()
                ...
                .specialEffects((new BiomeSpecialEffects.Builder())
                        ...
                        .backgroundMusic(Musics.createGameMusic(SoundsRegistry.TEST_BIOME_MUSIC.getHolder().get())).build()).build();
    }
}
